...
## Test helper: visible Label/Button text search (no invisible nodes).
func contains_visible_text(needle: String) -> bool:
	return _tree_contains_visible_text(self, needle)
...
func count_buttons() -> int:
	return _count_buttons(self)
...
func has_description_label() -> bool:
	return find_child("DescriptionLabel", true, false) != null
